...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(editView) name:@"EditViewAdded" object:nil];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dismissEditView) name:@"EditViewDismiss" object:nil];
...
#pragma mark - Edit Notification Methods
-(void)editView{
     NSUserDefaults *userDefault = [NSUserDefaults standardUserDefaults];
    [userDefault synchronize];
    ...
    controller.userdetailsDic = [globalDict mutableCopy];
    self.navigationController = [[UINavigationController alloc] initWithRootViewController:controller];
    self.window.rootViewController = self.navigationController;
...
//    self.navigationController = [[UINavigationController alloc] initWithRootViewController:controller];
    ...
    [tabBarcontroller setWantsFullScreenLayout:YES];
    self.window.rootViewController = tabBarcontroller;
    [tabBarcontroller.tabarController setSelectedIndex:4];
    [self.window makeKeyAndVisible];
}
@end
