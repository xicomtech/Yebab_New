...
@synthesize oauth_token,oauth_token_secret,oauth_verifier,oauth_token_authorized;
...
- (NSDictionary *) sessionPersistentData {
    ...
    if (self.oauth_verifier != nil) [data setObject:self.oauth_verifier forKey:kDMPersistentData_AuthTokenVerifier];
    return data;
}

- (void) loadPersistentData:(NSDictionary *) persistentDict {
    NSLog(@"persistantDIc: %@",persistentDict);
    ...
    self.oauth_verifier = [persistentDict objectForKey:kDMPersistentData_AuthTokenVerifier];
