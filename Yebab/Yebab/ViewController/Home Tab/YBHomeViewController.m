...
//        [cell.inThingsLabel setText:[NSString stringWithFormat:@"in %@",[[cellContentDic objectForKey:@"info"]objectForKey:@"albumName"]]];
        [cell.inThingsButton setTitle:[NSString stringWithFormat:@"in %@",[[cellContentDic objectForKey:@"info"]objectForKey:@"albumName"]] forState:UIControlStateNormal];
...
-(void)showAlbumList:(NSIndexPath *)indexPath{
    
    YBHomeViewController *homeController=[[YBHomeViewController alloc]initWithNibName:@"YBHomeViewController" bundle:nil];
    
    NSMutableDictionary *postParams = [[NSMutableDictionary alloc] init];
    [postParams setObject:USER_ID forKey:@"userid"];
 //   [postParams setObject:[[[responseArr objectAtIndex:indexPath.row] objectForKey:@"profile"] objectForKey:@"userId"] forKey:@"userid"];
    [postParams setObject:[[[responseArr objectAtIndex:indexPath.row] objectForKey:@"info"] objectForKey:@"albumId"] forKey:@"bid"];
    buttonIndexPath = indexPath;
    Connections *connections = [[Connections alloc] init];
    [connections setDelegate:self];
    [connections setRequestType:AlbumPicList];
    requestType = AlbumPicList;
    [connections sendRequestWithPath:AlbumPicList andParameters:postParams showLoader:YES];
